...
ggsave("~/Downloads/labmeeting_figs/pirna_simple_bar.png",g_lm_bar, height = 7.6, width = 8.3,units="in", dpi=150)
...
ggsave("~/Downloads/labmeeting_figs/sig_intra_grp_dist_n_tf_class.png",
       g_intra_grp_dist_n, width = 7, height = 6,units="in", dpi=150)




# transcription regulators ----------------------------------
ggsave("~/Downloads/labmeeting_figs/gene_group_gsea_bar.png",
       read_rds("results/plots/plot_gene_group_gsea.top10.rds")$plot + theme(axis.text.x = element_text(vjust=1)),width = 8, height = 8.4,units="in", dpi=150)



# tfrnai -----------------------------------------------------------------------
ggsave("~/Downloads/labmeeting_figs/tfrnai_coex_signature_gsea.bar.png",read_rds("results/plots/plot_tfrnai_gsea.plot_list.rds")$bar, width = 4, height = 4.2,units="in", dpi=150)
